...
class GeocoderController extends Controller
{
    ...
    public function forward(Request $request)
    {
        ...
        try {
            $geocoderType = setting("map.geocoderType", "google");
            $addresses = [];

            if ($geocoderType == "Opencage") {
                $opencageApiKey = setting('map.opencageApiKey');
                ...
                $radarApiKey = setting('map.radarApiKey');
                ...
                $locationiqApiKey = setting('map.locationiqApiKey');
                ...
                //google
                $googleMapKey = setting('googleMapKey');
    ...
    public function reverse(Request $request)
    {
        ...
        try {
            $geocoderType = setting("map.geocoderType", "google");
            $countiresSearch = setting('map.placeFilterCountryCodes');
            $addresses = [];
            ...
            if ($geocoderType == "Opencage") {
                ...
                //google
                $googleMapKey = setting('googleMapKey');
                $api = "https://maps.googleapis.com/maps/api/place/textsearch/json?query={$request->keyword}&key=$googleMapKey&region={$countiresSearch}";
                $response = Http::get($api);
