...
extension Localization on String {
  ...
  static var _t = Translations("en") +
      ...
      } +
      {
        ...
        "fr":
            "Veuillez saisir le montant à transférer de votre compte au portefeuille client",
        "es":
            "Ingrese la cantidad para transferir desde su cuenta a la billetera del cliente",
        "de":
            "Bitte geben Sie den Betrag ein, der von Ihrem Konto in die Kunden-Wallet überwiesen werden soll",
        "pt":
            "Insira o valor a ser transferido de sua conta para a carteira do cliente",
        "ar": "الرجاء إدخال المبلغ المراد تحويله من حسابك إلى محفظة العميل",
        "ko": "계정에서 고객 지갑으로 이체 할 금액을 입력하세요."
      } +
      {
        "en": "Transfer",
        "fr": "Transfert",
